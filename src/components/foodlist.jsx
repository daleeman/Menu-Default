            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4 bg-slate-50 h-96 w-96 hover:scale-105 duration-200">
              ...
              <div className="px-6 py-4 ">
                ...
                <p className="text-gray-700 text-base truncate">
                  ...
                  Quisquam voluptatem aspernatur molestias libero dicta nostrum
                  id quia eos. Perferendis ea numquam aut adipisci facere natus
                  voluptas quibusdam dolor consectetur? Voluptatibus.
                </p>
                <p className="text-base text-blue-500 font-semibold pt-3">
                  <span className="text-black">Price :</span> Rs {food.price}
                </p>
              </div>
              <button
                className="float-end text-lg bg-blue-500 px-3 rounded text-white hover:text-black cursor-pointer duration-200 m-5"
